...
function validateConfiguration(config) {
    ...
    if (config.discord.token != '') {
        if (config.discord.token.length < 0) errors.push('The discord token should be longer.');
        if (config.discord.serverId.length < 0) errors.push('The discord token should be longer.');
        if (config.discord.adminRoleId.length < 0) errors.push('The discord token should be longer.');
        if (config.discord.serverLogChannel.length < 0) errors.push('The discord token should be longer.');
        if (config.discord.commandLogChannel.length < 0) errors.push('The discord token should be longer.');
    }
